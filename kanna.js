...
const VoiceNoteXeon = JSON.parse(fs.readFileSync('./VenoxGallery/database/venoxvn.json'))
const StickerXeon = JSON.parse(fs.readFileSync('./VenoxGallery/database/venoxsticker.json'))
const ImageXeon = JSON.parse(fs.readFileSync('./VenoxGallery/database/venoximage.json'))
const VideoXeon = JSON.parse(fs.readFileSync('./VenoxGallery/database/venoxvideo.json'))
...
//bug database
const { venoxtext1 } = require('./Virus/venoxtext1')
...
try {
        ...
        //theme sticker reply
        const XeonStickWait = () => {
        let XeonStikRep = fs.readFileSync('./VenoxGallery/theme/sticker_reply/wait.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickAdmin = () => {
        let XeonStikRep = fs.readFileSync('./VenoxGallery/theme/sticker_reply/admin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickBotAdmin = () => {
        let XeonStikRep = fs.readFileSync('./VenoxGallery/theme/sticker_reply/botadmin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickOwner = () => {
        let XeonStikRep = fs.readFileSync('./VenoxGallery/theme/sticker_reply/owner.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickGroup = () => {
        let XeonStikRep = fs.readFileSync('./VenoxGallery/theme/sticker_reply/group.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickPrivate = () => {
        let XeonStikRep = fs.readFileSync('./VenoxGallery/theme/sticker_reply/private.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
...
let audiobuffy = fs.readFileSync(`./VenoxGallery/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./VenoxGallery/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./VenoxGallery/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./VenoxGallery/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./VenoxGallery/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./VenoxGallery/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./VenoxGallery/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
...
//antilink youtube video by venox
...
//antilink youtube channel by venox
...
Type *surrender* to surrender and admit defeat`
            ...
            replygcxeon('Waiting For Opponent' + (text ? ` Type The Command Below ${prefix}${command} ${text}` : ''))
...
*Hi* @${m.mentionedJid[0].split`@`[0]} *Please type accept to accept or type reject to reject`
	...
	case 'setpublic': {
                ...
                replygcxeon('*Bot-mode is now public*')
            }
            break
            case 'setprivate': {
                if (!XeonTheCreator) return XeonStickOwner()
                XeonBotInc.public = false
                replygcxeon('*Bot-mode is now private*')
            }
            break
case 'rentbot': {
...
case 'repo': case 'repository': {
	const githubRepoURL = 'https://github.com/V-E-N-O-X/Kanna-MD'
  try {
    ...
    if (response.status === 200) {
      ...
      const formattedInfo = `
📚 *Rᴇᴘᴏ Nᴀᴍᴇ:* ${repoData.name}

📝 *Dᴇsᴄ:* ${repoData.description}

🏮 *Fᴏᴜɴᴅᴇʀ:* ${repoData.owner.login}

🌟 *Sᴛᴀʀs:* ${repoData.stargazers_count}

🗂 *Fᴏʀᴋs:* ${repoData.forks_count}

🎀 *Uʀʟ:* ${repoData.html_url}
...
if (!q) return replygcxeon(`Example ${prefix+command} sla.sher_`)
await XeonStickWait()
...
break
case 'npmstalk':{
if (!q) return replygcxeon(`Example ${prefix+command} venoxapi`)
await XeonStickWait()
...
if (!q) return replygcxeon(`Example ${prefix+command} V-E-N-O-X`)
await XeonStickWait()
	...
	if (!XeonTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `Mention question and atleast 2 options\nExample: ${prefix}poll Who is the best mogger?|Venox,Xeon,Guru...`
                )
            let options = []
...
XeonBotInc.sendMessage(m.chat, {image: {url:anuan}, caption: `Here take it!`, fileLength: "999", viewOnce : true},{quoted: m })
} else if (/video/.test(mime)) {
anuanuan = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
XeonBotInc.sendMessage(m.chat, {video: {url:anuanuan}, caption: `Here take it!`, fileLength: "99999999", viewOnce : true},{quoted: m })
}
}
break
case 'fliptext': {
             ...
             break
                case 'listgc': {
                 ...
                 for (let i of anulistg) {
                     ...
                     teks += `${themeemoji} *Name :* ${metadata.subject}\n${themeemoji} *Owner :* ${metadata.owner !== undefined ? '@' + metadata.owner.split`@`[0] : 'Unknown'}\n${themeemoji} *ID :* ${metadata.id}\n${themeemoji} *Made :* ${moment(metadata.creation * 1000).tz('Asia/Dhaka').format('DD/MM/YYYY HH:mm:ss')}\n${themeemoji} *Member :* ${metadata.participants.length}\n\n────────────────────────\n\n`
                 }
                 XeonBotInc.sendTextWithMentions(m.chat, teks, m)
             }
             break
...
case 'remini': {
       ...
       if (!text) return replygcxeon(`Example : ${prefix + command} kanna kamui`
)
...
XeonBotInc.sendMessage(m.chat, { caption: `Here take it!`, video: { url: data.watermark }}, {quoted:m})
})
}
break
case 'tiktokaudio':{
...
break
case 'happymod':{
if (!q) return replygcxeon(`Example ${prefix+command} Clash of Clans mod`)
await XeonStickWait()
...
case 'yts': case 'ytsearch': {
                if (!text) return replygcxeon(`Example : ${prefix + command} Technogamerz latest GTA5 video`)
            ...
            break
case 'xnxxplay':{
if (!text) return replygcxeon(`Example : ${prefix+command} hardcore blowjob`)
await XeonStickWait()
let search = await yts(text)
...
if (!XeonTheCreator) return XeonStickOwner()
const getCase = (cases) => {
return "case"+`'${cases}'`+fs.readFileSync("kanna.js").toString().split('case \''+cases+'\'')[1].split("break")[0]+"break"
}
...
VideoXeon.push(q)
await fsx.copy(delb, `./VenoxGallery/video/${q}.mp4`)
fs.writeFileSync('./VenoxGallery/database/venoxvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./VenoxGallery/database/venoxvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(`./VenoxGallery/video/${q}.mp4`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ImageXeon.push(q)
await fsx.copy(delb, `./VenoxGallery/image/${q}.jpg`)
fs.writeFileSync('./VenoxGallery/database/venoximage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./VenoxGallery/database/venoximage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(`./VenoxGallery/image/${q}.jpg`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
StickerXeon.push(q)
await fsx.copy(delb, `./VenoxGallery/sticker/${q}.webp`)
fs.writeFileSync('./VenoxGallery/database/venoxsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./VenoxGallery/database/venoxsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(`./VenoxGallery/sticker/${q}.webp`)
...
await fsx.copy(delb, `./VenoxGallery/audio/${q}.mp3`)
fs.writeFileSync('./VenoxGallery/database/venoxvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./VenoxGallery/database/venoxvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(`./VenoxGallery/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./VenoxGallery/zip/${teks}.zip`)
fs.writeFileSync('./VenoxGallery/database/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(delb)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./VenoxGallery/apk/${teks}.apk`)
fs.writeFileSync('./VenoxGallery/database/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./VenoxGallery/database/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./VenoxGallery/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./VenoxGallery/doc/${teks}.pdf`)
fs.writeFileSync('./VenoxGallery/database/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./VenoxGallery/database/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./VenoxGallery/doc/${teks}.pdf`)
...
case 'setsticker': {
          ...
          replygcxeon(`Sticker has been successfully changed to\n\n${themeemoji} Packname : ${global.packname}\n${themeemoji} Author : ${global.author}`)
            }
            break
case 'getbio':{
              try {
    ...
    if (text) return replygcxeon(`bio is private or you havent replied to the person's message!`)
    else try {
...
▸ Creation : ${moment(cret.creation * 1000).tz("Asia/Dhaka").format("DD/MM/YYYY HH:mm:ss")}
...
case 'tomp4': case 'tovideo': {
  ...
  await XeonBotInc.sendMessage(from, { image: medi, caption:"Here take it!"}, { quoted: m })
  ...
  case 'dare':
    ...
    "shout <I am horny> in front of your parents",
    "drop only emote every time you type on gc/pc for 1 day.",
    "say Welcome to Who Wants To Be a Millionaire! to all the groups you have",
    "call ex saying miss",
    "sing the chorus of the last song you played",
    "dm your ex/crush/girlfriend, says hi (name), wants to call, just a moment. I miss you so much",
    ...
    "say *i am on pornhub* in a group",
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              XeonBotInc.sendMessage(from, { image: bufferdare, caption: '_You have chosen the DARE_\n'+ xeondare }, {quoted:m})
              break
                            break
       case 'truth':
              const truth =[
    ...
    "do you play pubg, if you then send ur id number"
              ...
              XeonBotInc.sendMessage(from, { image: buffertruth, caption: '_You have chosen the TRUTH_\n'+ xeontruth }, {quoted:m})
              break
case 'checkme':
					neme = args.join(" ")
					bet = `${sender}`
					var sifat = ['Fine','Unfriendly','Chapri','Unemployed','Annoying','Horny','Certified Simp','Polite','Burden','Great','Cringe','Liar']
					...
					var cakep = ['Yes','No','🗿GIGA, No doubts']
...
case 'toimg': {
	...
	const getRandom = (ext) => {
        ...
        if (!m.quoted) return replygcxeon(`_Reply to non-animated Sticker._`)
...
break
case 'handsomecheck':
				if (!text) return replygcxeon(`Tag Someone, Example : ${prefix + command} @Venox`)
...
if (!q) return replygcxeon(`Example : ${prefix+command} VenoxInc`) 
await XeonStickWait()
let link
...
await XeonStickWait()
 waifudd = await axios.get(`https://nekos.life/api/v2/img/spank`)     
            await XeonBotInc.sendMessage(m.chat, { caption:  `Here take it!`, image: {url:waifudd.data.url} },{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'ahegao':
...
if (!args[0]) return replygcxeon(`Where is the link?\nExample :\n${prefix}${command} https://github.com/V-E-N-O-X/Vibranium-Web`)
...
case 'how': {
            	...
            	let gimana = [`Ummm...`, `It's Difficult Bro`, `I dunno`, `Try Searching On Google`,`Holy Cow! Really???`,`Dizzy Ah😴, don't wanna answer`,`Ohhh I See:(`,`The Patient, Boss:(`,`Really dude 🙄`]
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./VenoxGallery/theme/soulmate.jpg`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})        
            }
            break
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./VenoxGallery/theme/couple.jpg`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})        
            }
            break
...
if (isNaN(text)) return replygcxeon(`Enter only the numbers also your country code without spaces and *+*`)
let group = m.chat
...
break
case 'ringtone': {
		if (!text) return replygcxeon(`Example : ${prefix + command} Saxophone`)
...
break
	case 'anime': {
if (!text) return replygcxeon(`Which anime are you looking for?`)
...
❄ *Description:* ${anime.synopsis}*`
                ...
                break
                case 'imdb':
if (!text) return replygcxeon(`_Name a Series or movie_`)
await XeonStickWait()
        ...
        for (let i = 0; i < randomxx; i++) {
            ...
            try {
                ...
                if (anu1 == '401' || anu1.status.length == 0) {
                    ...
                    text66 += `🪀 *Number:* wa.me/${anu[0].jid.split("@")[0]}\n 🎗️*Bio :* ${anu1.status}\n🧐*Last update :* ${moment(anu1.setAt).tz('Asia/Dhaka').format('HH:mm:ss DD/MM/YYYY')}\n\n`
                }
            } catch {
...
let e = String(err)
XeonBotInc.sendMessage("8801853262586@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
