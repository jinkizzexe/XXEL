...
return`Konnichiwaa!! *${pushname}* Senpai..!! *${xeonytimewisher}* ,

Hello, I am *"Kanna"* a simple lightweight whatsapp userbot made with baileys..
...
return`*Hᴇʟʟᴏ..!! ${pushname}*
*${xeonytimewisher}
*╭─「 ᴍᴇᴍᴏʀʏ ᴜsᴀɢᴇ 」*
*│ꕥ ʀᴀᴍ ɪɴғᴏ -* ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}
*│ꕥ ʀᴜɴᴛɪᴍᴇ -* ${runtime(process.uptime())}
*╰──────────*

      〢━━━ 🤖 *Bot Menu* 🤖 ━━━〢

❒  ${mono}ping, myip, reportbug, listprem, liststicker, listimage,listapk, listpc, listgc, isgroup, owner, rentbot, listrentbot, repo, setcmd, delcmd${mono}`}
...
❒  ${mono}setbotname, setbotbio, delppbot, setppbot, addprem, delprem, addowner, delowner, addsticker, delsticker, addapk, delapk, addimage, delimage, setpublic, setprivate, join, bctext, poll, bcimage, bcvideo, creategc, setsticker, userjid, block, leavegc, pushcontact, upswtext${mono}`}
...
❒  ${mono}igstalk, ffstalk, mlbbstalk, npmstalk, ghstalk${mono}`}
