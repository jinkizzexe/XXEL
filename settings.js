...
global.ownernomer = process.env.SUDO || '8801853262586' ; //add your Owner Number 
global.ownername = process.env.SUDO_NAME || '複|ᴠᴇɴᴏx' ; //add your owner name
...
global.ownernumber = process.env.OWNER_NUM || '8801853262586' ; //add your Owner Number 
global.ownername = process.env.OWNER_NAME || '複|ᴠᴇɴᴏx' ; //add your owner name
global.ownerNumber = ["8801928502256@s.whatsapp.net"]
...
global.creator = "8801853262586@s.whatsapp.net"
